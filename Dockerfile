...
RUN apt-get -yqq install python2.7 python-pip python-ldap python-jinja2 python-psycopg2 python-redis python-enum34 python-pil
RUN pip install django==1.8.7 dj-database-url
RUN mkdir /code
WORKDIR /code
ADD . /code/
